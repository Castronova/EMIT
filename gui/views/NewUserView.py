...
class NewUserView(wx.Frame):
    def __init__(self, parent):
        wx.Frame.__init__(self, parent=parent, title="Simple Notebook Example")

        # Create panel and notebook
        panel = wx.Panel(self)
...
class RegisterUserView(wx.Panel):
    def __init__(self, parent):
        ...
        white_space_label = wx.StaticText(self, label="")  # Created so the organization list box will be on the left
        white_space_label2 = wx.StaticText(self, label="")  # Created so the ok and cancel buttons will be on the left

        #  Text Boxes
        self.first_name_text_box = wx.TextCtrl(self)
        self.last_name_text_box = wx.TextCtrl(self)
        self.add_organization_btn = wx.Button(self, label="Add", style=wx.BU_EXACTFIT)
        self.edit_organization_btn = wx.Button(self, label="Edit", style=wx.BU_EXACTFIT)
        self.remove_organization_btn = wx.Button(self, label="Remove", style=wx.BU_EXACTFIT)
        self.organization_list_box = wx.ListBox(self)
